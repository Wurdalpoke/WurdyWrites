    ...
    this.state = {
      ...
      posts: [
              ...
              ["Why don’t people invest in Diamond or Platinum over Gold?", ["Economy", "Investing"] , [
                ...
                '',
                'By the way, if you’re wondering what the hell Microsoft did to earn so much; they only created an operating system that every other computer uses. And they did it at a time when computers were in the process of becoming a household appliance from just an esoteric piece of technology exclusive to scientists and their ilk.',
                ...
                '',
                'Gold is a great store of value because it is finite in the world, and although more is mined everyday, the gold already above the ground is so much that the mined quantity doesn’t change the total amount of gold in the world significantly.',
